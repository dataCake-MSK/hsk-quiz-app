...
|---|---|---|---|---|---|---|
| SRS-001 | M0 | 백엔드 스캐폴딩과 health API | 기반 | infra | todo | - |
| SRS-002 | M0 | Expo 앱 스캐폴딩과 백엔드 연결 확인 | 기반 | mobile | todo | - |
| SRS-003 | M0 | CI (backend lint·test, mobile typecheck·lint) | 기반 | infra | todo | - |
| SRS-004 | M0 | PostgreSQL 연결, 마이그레이션 도구, users 테이블 | 기반 | db | todo | - |
| SRS-010 | M1 | 회원가입 API | PRD-001 | auth | todo | - |
| SRS-011 | M1 | 로그인 API와 내 정보 조회 | PRD-001 | auth | todo | - |
| SRS-012 | M1 | 토큰 갱신 API | PRD-001 | auth | todo | - |
| SRS-013 | M1 | 앱 가입·로그인 화면과 토큰 보관 | PRD-001 | mobile | todo | - |
| SRS-014 | M1 | 인증 엔드포인트 rate limit과 CORS | PRD-001 | auth | todo | - |
| SRS-020 | M1 | 단어 테이블, 샘플 시드, 단어 목록 API | PRD-002 | words | todo | - |
| SRS-021 | M1 | 앱 단어 목록·상세 화면 | PRD-002, PRD-003 | mobile | todo | - |
| SRS-022 | M1 | 커스텀 단어 추가 | PRD-002 | words | todo | - |
| SRS-023 | M1 | 카테고리 태그와 필터 | PRD-003 | words | todo | - |
| SRS-024 | M1 | 단어 즐겨찾기 | PRD-004 | words | todo | - |
| SRS-025 | M1 | 리팩토링: Repository 패턴 도입 | PRD-004 | db | todo | - |
| SRS-030 | M1 | 혼동 관계 시드와 퀴즈 세션 시작 | PRD-005 | quiz | todo | - |
| SRS-031 | M1 | 다음 문제 생성 (혼동 단어 보기) | PRD-005 | quiz | todo | - |
| SRS-032 | M1 | 답변 제출과 숙련도 갱신 | PRD-005 | quiz | todo | - |
| SRS-033 | M1 | 세션 종료와 결과 화면 | PRD-005 | quiz | todo | - |
| SRS-034 | M1 | 즐겨찾기 퀴즈 + Strategy 패턴 도입 | PRD-004, PRD-005 | quiz | todo | - |
| SRS-035 | M1 | 뜻→단어 문제 유형 + Factory 패턴 도입 | PRD-005 | quiz | todo | - |
...
- 추적: NB-003, NB-004 → PRD-002, PRD-003 · 이슈: -
- AC
...
- 추적: NB-005, NB-012 → PRD-004, PRD-005 · 이슈: -
